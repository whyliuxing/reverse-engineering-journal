...
* System calls can be implemented using software interrupts, such as int 0x80 on x86 or SYSCALL on x86-64
  + SYSCALL invokes system call dispatcher by loading RIP from a MSR (Model Specific Register) 
  + On pre-Pentinum 2 processors, APIs call will eventually trigger int 0x2e, the system call dispatcher
#
