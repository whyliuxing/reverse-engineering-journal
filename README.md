...
* System calls can be implemented using software interrupts, such as int 0x80 on x86 or SYSCALL on x86-64
  + From Intel 64 and IA-32 Architectures Software Developer's Manual Volume 2: SYSCALL invokes an OS system-call handler at privilege level 0. It does so by loading RIP from a MSR (Model Specific Register)
#
